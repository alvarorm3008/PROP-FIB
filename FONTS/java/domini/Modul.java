...
/**
* Subclasse de la classe Operacio que representa l'operació de mòdul. Implementa els mètodes per incialitzar-la i realitzar el càlcul de l'operació.
*/
public class Modul extends Operacio {
    ...
    */
    public Modul(int id, String simbol) {
        super(id, simbol);
    }

    /**
    * Mètode que calcula l'operació mòdul dels enters indicats.
